    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="mt-4" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <img src="assets/admin/<?php echo $pecahdata['admin_foto']?>" width="200px" alt="">
        ...
        <?php 
          ...
          if (isset($_POST['simpan'])) {
            ...
            if ($size > 1000000 ) {
              ...
              move_uploaded_file($lokasifoto, 'assets/admin/'.$foto);


                    if (!empty($lokasifoto)) {
                      unlink("assets/admin/".$fotolama);
                      $update = $koneksi->query("UPDATE tb_admin SET admin_nama = '$nama', admin_username = '$username', admin_email = '$email', admin_foto = '$foto', admin_password = '$password' WHERE admin_id = '$id' ");
                    } else {
